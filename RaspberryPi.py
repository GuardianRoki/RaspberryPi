...
#///////////////////////////////////////////////////////////////////////////(Inputs For Computer Ship Placement)\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\#   
    ...
    while True:
        ...
        if turn == 1:
            ...
            if computerDisplayGrid[random_num1][random_num2] == (f"{Fore.LIGHTYELLOW_EX}{x}{Fore.BLUE}") and computerDisplayGrid[second_cord1][second_cord2] == (f"{x}") and computerDisplayGrid[random_num3][random_num4] == x and computerDisplayGrid[second_cord3][second_cord4] == x: 
